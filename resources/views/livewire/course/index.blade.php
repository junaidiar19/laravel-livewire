                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete" wire:click="showCourse({{ $course->id }})">Hapus</button>
                                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#edit" wire:click="showCourse({{ $course->id }})">Edit</button>
